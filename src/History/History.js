...
class History extends Component {
	...
	getCurrencyPrice = (date, currency) =>
        axios.get(`https://min-api.cryptocompare.com/data/pricehistorical?fsym=${currency}&tsyms=USD&ts=${date}&api_key=4392dd23a1f783826703215934a4f440cf92b3b7147651aa0438cf7b48752716`);
