...
class Today extends Component {
	...
	componentDidMount() {
		...
		this.pusher = new Pusher('556de54fbb85bc2e9824', {
			cluster: 'ap1',
			forceTLS: true
		});
		// Subscribe to the 'coin-prices' channel
		this.prices = this.pusher.subscribe('coin-prices');
		axios.get('https://min-api.cryptocompare.com/data/pricemulti?fsyms=BTC,ETH,LTC&tsyms=USD&api_key=4392dd23a1f783826703215934a4f440cf92b3b7147651aa0438cf7b48752716')
			.then(({ data: { BTC, ETH, LTC } }) => { // Since we're never using response or data directly might aswell deconstruct it here
				/**
